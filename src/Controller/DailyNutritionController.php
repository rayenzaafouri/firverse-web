...
class DailyNutritionController extends AbstractController
{
    ...
    public function show(string $date, NutritionRepository $nutritionRepository, FoodRepository $foodRepository, RecipeRepository $recipeRepository): Response
    {
    ...
    public function addItem(Request $request, string $date, string $mealType, FoodRepository $foodRepository, RecipeRepository $recipeRepository, NutritionRepository $nutritionRepository): Response
    {
